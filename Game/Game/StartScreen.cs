    ...
    public class StartScreen : DrawableGameComponent
    {
        ...
        public void Draw(SpriteBatch batch)
        {
            ...
            if (onStartScreen)
            {
                ...
                batch.DrawString(titleFont, title, new Vector2(((TankGame)Game).camera.position.X + 380, ((TankGame)Game).camera.position.Y + 652), Color.Black);
                batch.DrawString(titleFont, title, new Vector2(((TankGame)Game).camera.position.X + 384, ((TankGame)Game).camera.position.Y + 656), Color.BlanchedAlmond);
            }
