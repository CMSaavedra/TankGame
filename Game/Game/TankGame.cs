...
namespace Game
{
    public class TankGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            player1Tank.turretPosition = new Vector2(tankPos.X + 30, tankPos.Y + 25);
            Components.Add(player1Tank);

            tankPos2 = new Vector2(1918, 785);
            player2Tank = new Tank(this, tankPos2,-(float)Math.PI / 2);
            player2Tank.turretPosition = new Vector2(tankPos2.X + 30, tankPos2.Y + 25);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                currentTank.turretPosition.X = currentTank.tankPosition.X + 35;
            ...
            {
                currentTank.turretPosition.X = currentTank.tankPosition.X + 25;
                currentTank.turretPosition.Y = currentTank.tankPosition.Y + 15;
            }
            else
            {
